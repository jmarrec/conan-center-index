...
class SwigConan(ConanFile):
    ...
    def package_info(self):
        ...
        self.buildenv_info.define_path("SWIG_LIB", os.path.join(bindir, "swiglib"))

        self.runenv_info.prepend_path("PATH", bindir)
        self.runenv_info.define_path("SWIG_LIB", os.path.join(bindir, "swiglib"))
        ...
        self.env_info.SWIG_LIB = os.path.join(bindir, "swiglib")
